...
public class ClientDao implements IClientDao{
    ...
    public Client findClientById(int documentId) {
        ...
        PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            LOGGER.log(Level.SEVERE, "Error al recuperar un Cliente por Id. ", e.getMessage());
        }
        return null;
    }
    ...
    public boolean updateClient(Client client) {
        ...
        try (Connection connection = getConnection();
            ...
            LOGGER.log(Level.SEVERE, "Error al modificar al cliente: ", e.getMessage());
        }
    ...
    public boolean deleteClient(int documentId) {
        ...
        try (Connection connection = getConnection();
            ...
            LOGGER.log(Level.SEVERE, "Error al eliminar un cliente. ", e.getMessage());
        }
